...
image_train_path = './mnist_data_jpg/mnist_train_jpg_2000/'
label_train_path = './mnist_data_jpg/mnist_train_jpg_2000.txt'
tfRecord_train = './data/mnist_train.tfrecords'
image_test_path = './mnist_data_jpg/mnist_test_jpg_2000/'
label_test_path = './mnist_data_jpg/mnist_test_jpg_2000.txt'
