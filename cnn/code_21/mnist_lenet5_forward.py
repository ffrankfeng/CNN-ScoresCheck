...
def forward(x, train, regularizer):
    ...
    w1 = get_weight([FC_SIZE, OUTPUT_NODE], regularizer)
    b1 = get_bias([OUTPUT_NODE])
    y = tf.nn.relu(tf.matmul(fc1, w1) + b1)
    #
    ...
    # print([conv1_w, conv1_b, conv2_w, conv2_b, fc1_w, fc1_b, fc2_w, fc2_b])
