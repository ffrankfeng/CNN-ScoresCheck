...
from code_21 import mnist_lenet5_forward, mnist_generateds
import os
import numpy as np
from config import config
BATCH_SIZE = 1000#一个batch的数量
...
MODEL_SAVE_PATH=config.MODEL_SAVE_PATH_101
MODEL_NAME=config.MODEL_NAME_101
train_num_examples = 20000#2
