...
from code_41 import mnist_lenet5_forward as mnist_forward, mnist_lenet5_backward as mnist_backward
    ...
    with tf.Graph().as_default() as tg:
        ...
        with tf.Session() as sess:
            ...
            if ckpt and ckpt.model_checkpoint_path:
                ...
                print("40 No checkpoint file found")
                return -1
...
def main():
    for i in range(20):
        jr = application("../test_pic/pic_41/"+str(i)+".png")
        # jr = application("F:/PseudoDesktop/GANtest/5.jpg")
        print(jr.tostring())
