...
image_train_path = config.image_train_path_21
label_train_path = config.label_train_path_21
tfRecord_train = config.tfRecord_train_21
image_test_path = config.image_test_path_21
label_test_path = config.label_test_path_21
tfRecord_test = config.tfRecord_test_21
data_path = config.data_path_21
resize_height = 28
resize_width = 28
