...
from code.code_41 import mnist_lenet5_forward as mnist_forward, mnist_lenet5_backward as mnist_backward
...
def main():
    for i in range(20):
        jr = application(config.PROJECT_PATH+"/test_pic/pic_41/"+str(i)+".png")
