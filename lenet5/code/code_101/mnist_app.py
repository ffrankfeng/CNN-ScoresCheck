...
from code.code_101 import mnist_lenet5_backward as mnist_backward, mnist_lenet5_forward as mnist_forward
    ...
    with tf.Graph().as_default() as tg:
        ...
        with tf.Session() as sess:
            ...
            if ckpt and ckpt.model_checkpoint_path:
                ...
                print("100 No checkpoint file found")
                return -1
...
def main():
    for i in range(10):
        jr = application(config.PROJECT_PATH+"/test_pic/pic_101/"+str(i)+".png")
